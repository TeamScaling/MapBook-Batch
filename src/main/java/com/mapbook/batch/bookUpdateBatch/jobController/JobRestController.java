...
import static com.mapbook.batch.bookUpdateBatch.api.apiConnection.OpenApi.BATCH_KEY;
...
public class JobRestController {
    ...
    @PostMapping("/batch/start/loanCntUpdate")
    ...
    @PostMapping("/batch/restart/loanCntUpdate")
    ...
    @PostMapping("/batch/stop/loanCntUpdate")
